...
public class PokemonService {
    ...
    public Result Busqueda(Integer generacionId, Integer regionId, Integer tipoId, Integer offset){
        ...
        List<Pokemon> pokemonesFiltrados = pokemonesDTO.stream()
                                                       .filter(pokemon -> generacionId == null || (pokemon.getGeneracion() != null && Objects.equals(pokemon.getGeneracion().getId(), generacionId)))
                                                        .filter(pokemon -> regionId == null || (pokemon.getGeneracion().getId() == null) ? false : Objects.equals(pokemon.getGeneracion().getRegion().getIdRegion(), regionId))
    ...
    private void ordenarElementos(){
        ...
        if (!ordenados) {
            ...
            regionesDTO = regionesDTO.stream()
                .sorted(Comparator.comparing(Region::getIdRegion))
                .collect(Collectors.toList());
